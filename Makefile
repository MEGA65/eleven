...
11.parse.prg: FORCE 11.parse.asm
	...
	c1541 -attach $(PERSONAL_D81) -delete 11.parse -write 11.parse.prg 11.parse
...
from_personal_d81:
	c1541 -attach $(PERSONAL_D81) -read 11.defaults -read 11.edit -read 11.parse -read 11.post -read 11.settings -read autoboot.c65 -read readme,s
	$(MAKE) prg_to_bas
